...
function Progress() {
  this.percent = 0;
  this.size(0);
  this.~/Content/Login_v9/fontsize(11);
...
Progress.prototype.~/Content/Login_v9/fontsize = function(n){
  this._~/Content/Login_v9/fontsize = n;
  return this;
};
...
Progress.prototype.draw = function(ctx){
  var percent = Math.min(this.percent, 100)
    ...
    , y = half
    , rad = half - 1
    , ~/Content/Login_v9/fontsize = this._~/Content/Login_v9/fontsize;

  ctx.font = ~/Content/Login_v9/fontsize + 'px ' + this._font;
  ...
  ctx.fillText(
      text
    , x - w / 2 + 1
    , y + ~/Content/Login_v9/fontsize / 2 - 1);
