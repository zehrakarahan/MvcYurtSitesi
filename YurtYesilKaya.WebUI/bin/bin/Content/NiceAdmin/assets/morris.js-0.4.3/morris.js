(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.drawEmptyDonutLabel = function(xPos, yPos, color, ~/Content/Login_v9/fontsize, fontWeight) {
      var text;
      text = this.raphael.text(xPos, yPos, '').attr('font-size', ~/Content/Login_v9/fontsize).attr('fill', color);
      if (fontWeight != null) {
